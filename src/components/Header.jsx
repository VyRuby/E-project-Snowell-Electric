                        ...
                        <ul className='navbar-nav ms-auto'>
                            ...
                            <li class="nav-item mx-2 dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><Link to="/Products" class="dropdown-item" href="#">LED and Lighting</Link></li>
                                    <li><Link to="/Products" class="dropdown-item" href="#">Fans</Link></li>
                                    <li><Link to="/Products" class="dropdown-item" href="#">Heater</Link></li>
                                    <li><Link to="/Products" class="dropdown-item" href="#">Vacuum Cleaner</Link></li>
                                    <li><Link to="/Products" class="dropdown-item" href="#">Air Purifier</Link></li>
                                    <li><Link to="/Products" class="dropdown-item" href="#">Geysers</Link></li>
                                    <li><Link to="/Products" class="dropdown-item" href="#">Kitchen</Link></li>
                                </ul>
                            </li>
